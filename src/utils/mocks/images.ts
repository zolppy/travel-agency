...
const nature: Img[] = [
  {
    ...
    alt: "Ocean View",
    title:
      "An elevated view looking out over the ocean towards the horizon. Gentle waves with white foam crests are rolling onto a sandy beach at the bottom of the frame. The sky is partly cloudy, with patches of blue visible amongst white and dark gray clouds.",
  },
  {
    id: uuid(),
    src: mountains,
    alt: "Snowy Mountains",
    title:
      "A panoramic view of a snow-covered mountain range under a wide, cloudy sky. The mountains have rocky peaks and smooth, snow-covered slopes. In the foreground, dark, dense evergreen trees line the base of the mountains on the left and right sides.",
  },
];
